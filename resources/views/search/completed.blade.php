...
<div class="clearfix">
        {{-- complted problems table --}}
  
        <div class="banner" id="titleBanner" >
            <h1>Competed Problems</h1>
        </div>
    {{-- problem table --}}
        @if (count($completed_problems)>0)
        <div class="body" id="tableBody">
            ...
            @foreach ($completed_problems as $problem)
            ...
            @else
            <h3> There is no compeleted problem at the moment</h3>
        @endif
  </div>
@endsection